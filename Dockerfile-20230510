...
RUN wget  https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh \
    ...
    && conda update conda \
    && conda create -n cs_data_env \
    && conda init bash

RUN echo 'conda activate cs_data_env' >> /home/$APP_UNAME/.bashrc \
    && bash /home/$APP_UNAME/.bashrc \
    && conda install python=3.10 pip numpy notebook jupyterlab pymysql

WORKDIR /home/$APP_UNAME
RUN git clone https://github.com/SCECcode/cs-data-tools.git
#
# Add metadata to dockerfile using labels
LABEL "org.scec.project"="cs_data"
